...
static void init_array(int tsteps, int n, int m, DATA_TYPE POLYBENCH_3D(A, M, N, N, m, n, n))
{
    int i, j, k;
    const int BASE = 1024;
...
static void print_array(int tsteps, int n, int m, DATA_TYPE POLYBENCH_3D(A, M, N, N, m, n, n))
{
    int i, j, k;
