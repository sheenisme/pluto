...
static void init_array(int tsteps, int n, int m, DATA_TYPE POLYBENCH_2D(A, M, N, m, n))
{
    int i;
    const int BASE = 1024;
...
static void print_array(int tsteps, int n, int m, DATA_TYPE POLYBENCH_2D(A, M, N, m, n))
{
    int i;
